    ...
    return CustomScaffold(
      ...
      actions: [
        IconButton(
          ...
          onPressed: () =>
              context.go('/ingredient'), // NUEVO: navega a /ingredient
        ),

        // NUEVO: botón de acceso a Favoritos en la AppBar
        IconButton(
          tooltip: 'Favoritos',
          icon: const Icon(Icons.star, color: Colors.white),
          onPressed: () =>
              context.go('/favorites'), // NUEVO: navega a /favorites
        ),
        // 🔍 Búsqueda (nuevo)
        IconButton(
          tooltip: 'Buscar',
        ...
        //TODO: nUEVO ICONO DE "LISTA DE COMPRAS"
      ],
